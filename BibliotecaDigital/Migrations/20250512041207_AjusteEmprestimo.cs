...
{
    /// <inheritdoc />
    public partial class AjusteEmprestimo : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CriadoEm = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    Multa = table.Column<float>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Multa = table.Column<float>(type: "float", nullable: false),
                    dataDeExpircao = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    CriadoEm = table.Column<DateTime>(type: "datetime(6)", nullable: false),
